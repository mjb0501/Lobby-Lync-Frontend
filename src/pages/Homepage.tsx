    ...
    <div className="min-h-screen bg-slate-600 flex items-start justify-center py-44">
        <div className="bg-slate-500 rounded-lg shadow-lg p-8 w-full max-w-md">
            ...
            <p className="text-lg text-gray-300 mb-6">
                Grouply is the ultimate platform for gamers to connect! Create and join groups for your favorite games, find new teammates, and build your gaming community.
            </p>
